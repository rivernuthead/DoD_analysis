...
for run in runs:
    ...
    for jump in jumps:    
        ...
        np.savetxt(os.path.join(output_dir, 'class1_distribution_DEM2DEM.txt'), np.round(hist_1, decimals=2))
        ...
        np.savetxt(os.path.join(output_dir, 'class2_distribution_DEM2DEM.txt'), np.round(hist_2, decimals=2))
        ...
        np.savetxt(os.path.join(output_dir, 'class3_distribution_DEM2DEM.txt'), np.round(hist_3, decimals=2))
        ...
        np.savetxt(os.path.join(output_dir, 'class4_distribution_DEM2DEM.txt'), np.round(hist_4, decimals=2))
        ...
        np.savetxt(os.path.join(output_dir, 'class5_distribution_DEM2DEM.txt'), np.round(hist_5, decimals=2))
        ...
        np.savetxt(os.path.join(output_dir, 'class7_distribution_DEM2DEM.txt'), np.round(hist_6, decimals=2))
        ...
        np.savetxt(os.path.join(output_dir, 'class7_distribution_DEM2DEM.txt'), np.round(hist_7, decimals=2))
