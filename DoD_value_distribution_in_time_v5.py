...
for run in runs:
    ...
    for timespan in range(1,data.shape[3]+1):
    # timespan = 1
    ...
    #%%
        ...
        plt.savefig(os.path.join(report_dir, run + '_overall_dist_chart.pdf'), dpi=300)
    ...
    #%%
        for i in range(overall_dist_matrix.shape[0]):
            ...
            # plt.xlabel('X Values')
            # plt.ylabel('Y Values')
            plt.title(run + ' - Class interval: ' + class_labels[i])
            # plt.xticks(bin_edges)
            # Save the figure to a file (e.g., 'scatter_plot.png')
            plt.savefig(os.path.join(report_dir, run + '_' + str(i) + '_overall_dest_probability.pdf'), dpi=300)
    ...
    #%%
        ...
        # Set a title
        plt.title('Stacked Bar Chart - ' + run)
        ...
        plt.savefig(os.path.join(report_dir, 'dist_step_by_step', run + '_overall_didstribution_SCO_FILL.pdf'), dpi=300)
    ...
    #%%
        ...
        np.savetxt(os.path.join(report_dir, 'partial_class1_distribution_sco.txt'), np.round(dist_array_sco_partial_class1_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class2_distribution_sco.txt'), np.round(dist_array_sco_partial_class2_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class3_distribution_sco.txt'), np.round(dist_array_sco_partial_class3_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class4_distribution_sco.txt'), np.round(dist_array_sco_partial_class4_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class5_distribution_sco.txt'), np.round(dist_array_sco_partial_class5_matrix, decimals=2), delimiter=',')
        
        np.savetxt(os.path.join(report_dir, 'partial_class_uthrs_distribution.txt'), np.round(dist_array_uthrs_partial_class_matrix, decimals=2), delimiter=',')
        
        np.savetxt(os.path.join(report_dir, 'partial_class6_distribution_dep.txt'), np.round(dist_array_dep_partial_class6_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class7_distribution_dep.txt'), np.round(dist_array_dep_partial_class7_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class8_distribution_dep.txt'), np.round(dist_array_dep_partial_class8_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class9_distribution_dep.txt'), np.round(dist_array_dep_partial_class9_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(report_dir, 'partial_class10_distribution_dep.txt'), np.round(dist_array_dep_partial_class10_matrix, decimals=2), delimiter=',')
