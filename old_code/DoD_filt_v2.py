...
#%%         ###################################################################
            ...
            # TODO Check: should this be applied only for delta==1 DoD???
            ...
            act_width_array = np.array([np.nansum(act_px_matrix/(W/(px_y/1000)), axis=0)]) # Array of the crosswise morphological total active width in number of active cells [-]
            act_width_array_dep = np.array([np.nansum(act_px_matrix_dep/(W/(px_y/1000)), axis=0)]) # Array of the crosswise morphological deposition active width in number of active cells [-]
            act_width_array_sco = np.array([np.nansum(act_px_matrix_sco/(W/(px_y/1000)), axis=0)]) # Array of the crosswise morphological scour active width in number of active cells [-]
