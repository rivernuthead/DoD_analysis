...
for run in runs:
    ...
    #%%
        ...
        if 'overall_class_distribution_stacked' in plot_mode:
            ...
            if 'active_DoD_area_only' in run_mode:
                plot_path = os.path.join(output_dir, run + '_Jump' + str(jump) + '_overall_distribution_DEM2DoD_act_only.pdf')
        ...
        if 'overall_class_distribution_bars' in plot_mode:
            ...
            if 'active_DoD_area_only' in run_mode:
                plot_path = os.path.join(output_dir, run + '_jump' + str(jump) + '_DEM2DoD_overall_disstribution_sep_act_only.pdf')
            plt.savefig(plot_path, dpi=300)
    ...
    #%%
        ...
        if 'overall_class_distribution_bars_sup_up' in plot_mode:
            ...
            # Save image and report
            plot_path = os.path.join(output_dir, run + '_jump' + str(jump) + '_DEM2DoD_overall_disstribution_sep_summary.pdf')
            
            if 'active_DoD_area_only' in run_mode:
                plot_path = os.path.join(output_dir, run + '_jump' + str(jump) + '_DEM2DoD_overall_disstribution_sep_act_only_summary.pdf')
            plt.savefig(plot_path, dpi=300)
