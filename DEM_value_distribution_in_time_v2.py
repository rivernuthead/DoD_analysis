            ...
            for x in range(DEM_data.shape[1]):
                for y in range(DEM_data.shape[2]):
                    ...
                    if DEM_bin_edges[0]<=matrix[t,x,y]<DEM_bin_edges[1]:
                        dist_array_sco_class1 = np.append(dist_array_sco_class1, computed_DEM_data[t+jump,x,y])
                        dist_array_sco_partial_class1 = np.append(dist_array_sco_partial_class1, computed_DEM_data[t+jump,x,y])
                    if DEM_bin_edges[1]<=matrix[t,x,y]<DEM_bin_edges[2]:
                        dist_array_sco_class2 = np.append(dist_array_sco_class2, computed_DEM_data[t+jump,x,y])
                        dist_array_sco_partial_class2 = np.append(dist_array_sco_partial_class2, computed_DEM_data[t+jump,x,y])
                    if DEM_bin_edges[2]<=matrix[t,x,y]<DEM_bin_edges[3]:
                        dist_array_sco_class3 = np.append(dist_array_sco_class3, computed_DEM_data[t+jump,x,y])
                        dist_array_sco_partial_class3 = np.append(dist_array_sco_partial_class3, computed_DEM_data[t+jump,x,y])
                    if DEM_bin_edges[3]<=matrix[t,x,y]<DEM_bin_edges[4]:
                        dist_array_sco_class4 = np.append(dist_array_sco_class4, computed_DEM_data[t+jump,x,y])
                        dist_array_sco_partial_class4 = np.append(dist_array_sco_partial_class4, computed_DEM_data[t+jump,x,y])
                    if DEM_bin_edges[4]<=matrix[t,x,y]<DEM_bin_edges[5]:
                        dist_array_sco_class5 = np.append(dist_array_sco_class5, computed_DEM_data[t+jump,x,y])
                        dist_array_sco_partial_class5 = np.append(dist_array_sco_partial_class5, computed_DEM_data[t+jump,x,y])
                    if DEM_bin_edges[5]<matrix[t,x,y]<DEM_bin_edges[6]:
                        dist_array_dep_class6 = np.append(dist_array_dep_class6, computed_DEM_data[t+jump,x,y])
                        dist_array_dep_partial_class6 = np.append(dist_array_dep_partial_class6, computed_DEM_data[t+jump,x,y])
                    if DEM_bin_edges[6]<=matrix[t,x,y]<DEM_bin_edges[7]:
                        dist_array_dep_class7 = np.append(dist_array_dep_class7, computed_DEM_data[t+jump,x,y])
                        dist_array_dep_partial_class7 = np.append(dist_array_dep_partial_class7, computed_DEM_data[t+jump,x,y])
