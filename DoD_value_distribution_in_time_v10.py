...
for run in runs:
    ...
    #%%
        ...
        np.savetxt(os.path.join(output_dir, 'partial_class1_distribution_sco_timespan'+str(timespan)+ '.txt'), np.round(dist_array_sco_partial_class1_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class2_distribution_sco_timespan'+str(timespan) +'.txt'), np.round(dist_array_sco_partial_class2_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class3_distribution_sco_timespan'+str(timespan) +'.txt'), np.round(dist_array_sco_partial_class3_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class4_distribution_sco_timespan'+str(timespan) +'.txt'), np.round(dist_array_sco_partial_class4_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class5_distribution_sco_timespan'+str(timespan) +'.txt'), np.round(dist_array_sco_partial_class5_matrix, decimals=2), delimiter=',')
        
        np.savetxt(os.path.join(output_dir, 'partial_class_uthrs_distribution_timespan'+str(timespan) +'.txt'), np.round(dist_array_uthrs_partial_class_matrix, decimals=2), delimiter=',')
        
        np.savetxt(os.path.join(output_dir, 'partial_class6_distribution_dep_timespan'+str(timespan) +'.txt'), np.round(dist_array_dep_partial_class6_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class7_distribution_dep_timespan'+str(timespan)+ '.txt'), np.round(dist_array_dep_partial_class7_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class8_distribution_dep_timespan'+str(timespan) +'.txt'), np.round(dist_array_dep_partial_class8_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class9_distribution_dep_timespan'+str(timespan) +'.txt'), np.round(dist_array_dep_partial_class9_matrix, decimals=2), delimiter=',')
        np.savetxt(os.path.join(output_dir, 'partial_class10_distribution_dep_timespan'+str(timespan)+ '.txt'), np.round(dist_array_dep_partial_class10_matrix, decimals=2), delimiter=',')
