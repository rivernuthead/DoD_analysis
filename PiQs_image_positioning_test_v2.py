...
if run_name == 'q20r1':
    ...
    image = imageio.imread('/home/erri/Documents/PhD/Research/5_research_repos/PiQs_analysis/Maps/q20r1/q20r1_envBAA_map_activ_history.tiff')
...
if run_name == 'q20r1':
    # Define the transformation parameters
    scale = 1.2 # Enlargement scale
    dx = 3 # Shift in x direction
    dy = 3 # Shift in y direction
    rot_angle = -0.45
...
img2 = plt.imshow(image_rsh, alpha=0.5, cmap='cool', origin='upper', vmin=-10, vmax=+10, interpolation_stage='rgba')

# Set title and show the plot
plt.title(run_name)
plt.axis('off')
plt.savefig(os.path.join(report_dir, 'surveys_images_overlapping_test', run_name + '_DEM_photo_ovelapping.tiff'), dpi=600)
