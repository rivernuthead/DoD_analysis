...
home_dir = '/home/erri/Documents/morphological_approach/3_output_data/q1.0_2/2_prc_laser/'
w_dir = os.path.join(home_dir, 'surveys')
files=[]
...
for h in range (0, len(files)-1):
    for k in range (0, len(files)-1-h):
        ...
        dir_out = os.path.join(home_dir, 'DoDs')
