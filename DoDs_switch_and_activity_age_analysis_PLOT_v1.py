...
for run in runs:
    ...
    if 'periods_dist' in plot_mode:
        ...
        time_array_cld  = time_array[(time_array != 0) & (~np.isnan(time_array))] # Trim np.nan and zeros
        sco_time_array  = time_array*(time_array<0)
        dep_time_array = time_array*(time_array>0)
