...
for run_name, set_name in zip(run_names, set_names):
    ...
    path_partial_envelopes = os.path.join('/home/erri/Documents/PhD/Research/5_research_repos/PiQs_analysis/output_report/partial_envelopes', run + '_envTscale' + str(env_tscale))
    stack_bool_diff_cld_path = os.path.join(path_partial_envelopes, run+ '_envT' + str(env_tscale) + '_partial_stack_bool_diff_cld.npy')
    stack_bool_diff_cld = np.load(stack_bool_diff_cld)  
