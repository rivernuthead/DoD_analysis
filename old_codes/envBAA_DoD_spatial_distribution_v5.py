...
for run_name, set_name in zip(run_names, set_names):
    ...
    BAA_path = '/home/erri/Documents/PhD/Research/5_research_repos/PiQs_analysis/Maps/'+run_name+'/'+run_name+'_envBAA_map.tiff'
    ...
    # Import the Morphological active area (MAA) envelope
    ...
    img2 = plt.imshow(envBAA_rsz_rsc, cmap='Purples', alpha=0.5, vmin=0, vmax=1)
