...
# DEM2DoD
DEM_c7_to_DoD = DEM0_c7*DoD1_0 # DoD values that were in DEM c7
# DEM_c7_to_DoD_c4 = np.where(np.logical_and(abs(DEM_c7_to_DoD<1.3),DEM_c7_to_DoD!=0), 1, 0) # DoD values that were in DEM c7 and are in DoD c4
from_DEM_c7_to_DoD_c4 = np.where(abs(DEM_c7_to_DoD<=1.3), 1, np.nan) # DoD values that were in DEM c7 and are in DoD c4
